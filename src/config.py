...
class Config:
    ...
    def get_yidun_config(cls) -> Dict[str, Any]:
        ...
        return {
            ...
            "text_url": os.getenv("YIDUN_TEXT_URL", "https://as.dun.163.com/v5/text/check"),
            "image_url": os.getenv("YIDUN_IMAGE_URL", "https://as.dun.163.com/v5/image/check"),
        }
    
    @classmethod
    def get_juntong_config(cls) -> Dict[str, Any]:
        """Get Juntong (君同) configuration."""
        return {
            "app_key": os.getenv("JUNTONG_APP_KEY", ""),
            "app_secret": os.getenv("JUNTONG_APP_SECRET", ""),
            "text_url": os.getenv("JUNTONG_TEXT_URL", ""),
            "image_url": os.getenv("JUNTONG_IMAGE_URL", ""),
        }
